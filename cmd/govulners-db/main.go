...
import (
	...
	"github.com/nextlinux/govulners-db/cmd/govulners-db/cli"
...
func main() {
	...
	// note: it is important to always do signal handling from the main package. In this way if govulners-db is used
