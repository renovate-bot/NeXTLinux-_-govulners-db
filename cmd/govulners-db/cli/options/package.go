...
func DefaultPackage() Package {
	return Package{
		PublishBaseURL: "https://localhost:8080/govulners/databases",
	}
}
...
func (o *Package) AddFlags(flags *pflag.FlagSet) {
	...
	flags.StringVarP(
		...
		"archive-extension", "e",
		o.OverrideArchiveExtension,
		"Override the extension used during DB archiving (default is 'tar.gz' or 'tar.zst' based on the govulners DB schema)")
}
