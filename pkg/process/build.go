...
import (
	...
	v1 "github.com/anchore/govulners-db/pkg/process/v1"
	v2 "github.com/anchore/govulners-db/pkg/process/v2"
	v3 "github.com/anchore/govulners-db/pkg/process/v3"
	v4 "github.com/anchore/govulners-db/pkg/process/v4"
	v5 "github.com/anchore/govulners-db/pkg/process/v5"
	"github.com/anchore/govulners-db/pkg/provider"
	"github.com/anchore/govulners-db/pkg/provider/entry"
	"github.com/anchore/govulners-db/pkg/provider/unmarshal"
	govulnersDBv1 "github.com/anchore/govulners/govulners/db/v1"
	govulnersDBv2 "github.com/anchore/govulners/govulners/db/v2"
	govulnersDBv3 "github.com/anchore/govulners/govulners/db/v3"
	govulnersDBv4 "github.com/anchore/govulners/govulners/db/v4"
	govulnersDBv5 "github.com/anchore/govulners/govulners/db/v5"
)
