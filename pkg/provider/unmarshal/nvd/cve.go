...
import (
	...
	"github.com/nextlinux/govulners-db/pkg/provider/unmarshal/nvd/cvss20"
	"github.com/nextlinux/govulners-db/pkg/provider/unmarshal/nvd/cvss30"
	"github.com/nextlinux/govulners-db/pkg/provider/unmarshal/nvd/cvss31"
)
...
// this is the struct to use when unmarshalling directly from the API (which govulners-db is NOT doing)
